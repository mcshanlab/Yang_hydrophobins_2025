...
pdb_dest_dir = "./10cys_pdbs_classII/"  # destination directory for copied PDBs
...
with open("10cys_classII.txt", "w") as output_file:
    # Grab sequences
...
# Write species table
with open("10cys_species_table_classII.txt", "w") as table_file:
...
# Write total count
with open("10cys_total_count_classII.txt", "w") as count_file:
