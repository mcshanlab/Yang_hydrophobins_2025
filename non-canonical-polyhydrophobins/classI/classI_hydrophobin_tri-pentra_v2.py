...
categories = {
    "Trihydrophobin": {
        "name": "Trihydrophobin",
        "pdb_dir": "classI-trihydrophobin",
        "fasta_file": "classI_Trihydrophobin_seqs.txt",
        "species_file": "classI_Trihydrophobin_species_table.txt",
        "count_file": "classI_Trihydrophobin_total_count.txt",
        "species_count": defaultdict(int),
        "seq_count": 0
    },
    "Pentahydrophobin": {
        "name": "Pentahydrophobin",
        "pdb_dir": "classI-pentahydrophobin",
        "fasta_file": "classI_Pentahydrophobin_seqs.txt",
        "species_file": "classI_Pentahydrophobin_species_table.txt",
        "count_file": "classI_Pentahydrophobin_total_count.txt",
        "species_count": defaultdict(int),
        "seq_count": 0
    }
}
