...
def find_classII_folders(base_dir):
    """Find folders containing 'classII_' in the name."""
    classII_folders = []
    for root, dirs, files in os.walk(base_dir):
        for d in dirs:
            if 'classII_' in d:
                classII_folders.append(os.path.join(root, d))
    return classII_folders
...
def main():
    base_dir = os.getcwd()
    folders = find_classII_folders(base_dir)
    ...
    text_output_path = os.path.join(base_dir, "classII_foldseek_description_hits_summary.txt")
    pdf_output_path = os.path.join(base_dir, "classII_foldseek_description_hits_summary.pdf")
