...
plt.title(f"{len(sizes)} Class II hydrophobins <250 aa")
plt.xlabel("Sequence length (amino acids)")
plt.ylabel("Count")
plt.xlim(0, 250)
plt.savefig("classII_hydrophobin_length_lt250.pdf", format="pdf", bbox_inches="tight")
plt.show()
...
plt.ylabel("Count")
plt.legend()
plt.savefig("classII_hydrophobin_preC_split_histogram.pdf", format="pdf", bbox_inches="tight")
plt.show()
